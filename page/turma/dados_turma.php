          ...
          <div class="col-12">
            <div class="card">  
             <div class="card-header">
                <h5 class="fw-bold card-title">Dados Turma</h5>
              </div>    
             <div class="card-body">    
            
 
<a  data-bs-toggle="modal" data-bs-target="#myModal"><btn class="btn btn-primary btn-sm"> + Turma</btn></a>  
<a href="#"> <btn class="btn btn-primary btn-sm">Imprimi Turma</btn> </a>
