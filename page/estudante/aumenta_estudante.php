...
<?php
    if(isset($_POST['aumentas'])){
        ...
        $aumentadatatama = mysqli_query($mysqli, "INSERT INTO tbl_estudante2 (nre, estudante, sexo, munisipio, contacto, id_ano, inan, aman, fatin_moris, data_moris, regime, id_status) values('$nree', '$naran', '$sexo', '$munisipiu', '$kontak', '$tinanakd', '$inan', '$aman', '$fatinm', '$dmoris', '$regim', '$status')");
        if($aumentadatatama){
